  ...
  <div class="total-user">
    ...
    <div class="percent-text">
      ...
      <span class="percent-text-2">
        每月增长率:
        <countTo :startVal="startPercent2"
...
export default {
  ...
  setup(props) {
    ...
    // 监听器
    watch(() => props.todayUser, (nextVal, preVal) => {
      startVal.value = preVal
    })
    watch(() => props.growthLastDay, (nextVal, preVal) => {
      startPercent.value = preVal
    })
    watch(() => props.growthLastMonth, (nextVal, preVal) => {
